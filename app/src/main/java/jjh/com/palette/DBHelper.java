...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {//테이블 생성
        ...
        db.execSQL("CREATE TABLE TagName (tagName VARCHAR2(20));"); //태그 종류를 가진 테이블
        db.execSQL("CREATE TABLE Theme (library VARCHAR2(20), name VARCHAR2(20), color VARCHAR2(20)" +
                ...
                ", FOREIGN KEY(tag1) REFERENCES Library(TagName)" +
                ", FOREIGN KEY(tag2) REFERENCES Library(TagName)" +
                ", FOREIGN KEY(tag3) REFERENCES Library(TagName));");
